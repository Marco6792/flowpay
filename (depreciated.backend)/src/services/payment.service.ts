...
import { PaymentRequest } from './providers/provider.interface.ts';
...
export class PaymentService {
  async createPayment(data: CreatePaymentInput & { provider?: string; providerMode?: string; providerOptions?: any }, apiKeyId: string): Promise<Payment> {
    try {
