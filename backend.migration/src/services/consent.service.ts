...
export class ConsentService {
   ...
   */
  async createConsent(data: CreateConsentRequest, mode: ProviderMode = 'SANDBOX'): Promise<ConsentServiceResponse> {
    try {
   ...
   */
  async getTokenFromConsent(data: TokenFromConsentRequest, mode: ProviderMode = 'SANDBOX'): Promise<TokenResponse> {
    try {
      const provider = this.getProviderInstance(data.provider || 'MTN', mode);
   ...
   */
  async getUserInfoFromToken(data: UserInfoFromTokenRequest, mode: ProviderMode = 'SANDBOX') {
    try {
      const provider = this.getProviderInstance(data.provider || 'MTN', mode);
   ...
   */
  async refreshOAuth2Token(data: RefreshTokenRequest, mode: ProviderMode = 'SANDBOX'): Promise<TokenResponse> {
    try {
      const provider = this.getProviderInstance(data.provider || 'MTN', mode);
   ...
   */
  async revokeConsent(data: RevokeConsentRequest, mode: ProviderMode = 'SANDBOX') {
    try {
      const provider = this.getProviderInstance(data.provider || 'MTN', mode);
   ...
   */
  async getBasicUserInfo(data: BasicUserInfoRequest, mode: ProviderMode = 'SANDBOX') {
    try {
      const provider = this.getProviderInstance(data.provider || 'MTN', mode);
