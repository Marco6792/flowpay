...
import { DepositStatusEnum, TransferStatusEnum, WithdrawStatusEnum } from './providers/provider.interface';
...
export class PollingService {
  ...
  private async pollDepositStatus(
    ...
    try {
      const provider = ProviderFactory.getProvider(providerType as any, 'SANDBOX');
      if (!provider) {
